...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('questionaire_questionaire', (
            ...
            ('sub_title', self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=512, null=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=32)),
            ('overline_text', self.gf('django.db.models.fields.CharField')(blank=True, max_length=128, null=True)),
        ...
        db.create_table('questionaire_question', (
            ...
            ('related_content_link', self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=512)),
            ('related_content_text', self.gf('django.db.models.fields.CharField')(blank=True, default='', max_length=512)),
        ))
    ...
    models = {
        ...
        'questionaire.question': {
            ...
            'related_content_link': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "''", 'max_length': '512'}),
            'related_content_text': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "''", 'max_length': '512'}),
            'sequence_order': ('django.db.models.fields.IntegerField', [], {})
        },
        'questionaire.questionaire': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'overline_text': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '128', 'null': 'True'}),
            'score_text': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'sub_title': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "''", 'max_length': '512', 'null': 'True'}),
